		...
		<ul class="menu-list">
			...
			<li class="dropdown menu-list__item">
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
					<li><a class="dropdown-item" href="./?dir=admin&controller=Attendance&action=Index">Pasar Asistencia</a></li>
					<li><a class="dropdown-item" href="./?dir=admin&controller=Attendance&action=AttendanceRecord">Ver Registro</a></li>
				</ul>
			</li>
			<li class="menu-list__item">
			...
			<li class="dropdown menu-list__item">
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
					<li><a class="dropdown-item" href="./?dir=admin&controller=Student&action=Index&id=main">Estudiantes</a></li>
					<li><a class="dropdown-item" href="./?dir=admin&controller=Teacher&action=Index&id=main">Profesores</a></li>
					<li><a class="dropdown-item" href="./?dir=admin&controller=Staff&action=AdminViews&id=main">Administradores</a></li>
					<li><a class="dropdown-item" href="./?dir=admin&controller=Staff&action=BillingViews&id=main">Cobros</a></li>
				</ul>
			</li>
			<li class="menu-list__item">
