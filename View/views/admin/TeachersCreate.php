...
<body>
	...
	<main class="d-flex">
		...
		<div class="w-50 mx-auto mt-4 rounded general-shadow mobile-target overflow-hidden">
			...
			<form id="manualForm" action="./?dir=admin&controller=Teacher&action=Create" method="POST" class="px-4 pb-4" enctype="multipart/form-data">
	...
	<form id="formSendExcel" action="./?dir=admin&controller=Teacher&action=CreateFromJSON" method="post" hidden>
